...
readTime: "12 min"
pros:
  - "Strong natural language control for realism"
  - "Great for clean brand safe imagery"
  - "Consistent lighting with clear cues"
cons:
  - "Limited manual parameter controls"
  - "Safety filters can block edge cases"
  - "Paid access for heavy use"
