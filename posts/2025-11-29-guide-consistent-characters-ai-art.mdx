...
readTime: "12 min"
pros:
  - "Helps build recognizable characters"
  - "Works across tools with reference discipline"
  - "Reduces redesign time"
cons:
  - "Consistency drifts without references"
  - "Requires prompt and style lock in"
  - "Some models lack seed control"
---
